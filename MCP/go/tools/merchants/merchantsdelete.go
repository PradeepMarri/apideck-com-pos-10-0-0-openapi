...
func MerchantsdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/pos/merchants/%s%s", cfg.BaseURL, id, queryString)
		...
		var result models.DeleteMerchantResponse
...
func CreateMerchantsdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_pos_merchants_id",
		mcp.WithDescription("Delete Merchant"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    MerchantsdeleteHandler(cfg),
	}
}
