...
func MerchantsoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetMerchantResponse
...
func CreateMerchantsoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pos_merchants_id",
		mcp.WithDescription("Get Merchant"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    MerchantsoneHandler(cfg),
	}
}
