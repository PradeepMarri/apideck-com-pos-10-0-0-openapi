...
func MerchantsallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetMerchantsResponse
...
func CreateMerchantsallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pos_merchants",
		mcp.WithDescription("List Merchants"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    MerchantsallHandler(cfg),
	}
}
