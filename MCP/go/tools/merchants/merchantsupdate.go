...
func MerchantsupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.UpdateMerchantResponse
...
func CreateMerchantsupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_pos_merchants_id",
		mcp.WithDescription("Update Merchant"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    MerchantsupdateHandler(cfg),
	}
}
