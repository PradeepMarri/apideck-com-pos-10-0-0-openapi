...
func ItemsdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/pos/items/%s%s", cfg.BaseURL, id, queryString)
		...
		var result models.DeleteItemResponse
...
func CreateItemsdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_pos_items_id",
		mcp.WithDescription("Delete Item"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ItemsdeleteHandler(cfg),
	}
}
