...
func ItemsupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.UpdateItemResponse
...
func CreateItemsupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_pos_items_id",
		mcp.WithDescription("Update Item"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ItemsupdateHandler(cfg),
	}
}
