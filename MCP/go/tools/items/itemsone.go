...
func ItemsoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateItemsoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pos_items_id",
		mcp.WithDescription("Get Item"),
