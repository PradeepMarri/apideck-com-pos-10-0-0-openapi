...
func LocationsdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteLocationResponse
...
func CreateLocationsdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_pos_locations_id",
		mcp.WithDescription("Delete Location"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    LocationsdeleteHandler(cfg),
	}
}
