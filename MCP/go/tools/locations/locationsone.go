...
func LocationsoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetLocationResponse
...
func CreateLocationsoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pos_locations_id",
		mcp.WithDescription("Get Location"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    LocationsoneHandler(cfg),
	}
}
