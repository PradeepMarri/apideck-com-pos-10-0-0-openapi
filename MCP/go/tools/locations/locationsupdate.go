...
func LocationsupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/pos/locations/%s%s", cfg.BaseURL, id, queryString)
		...
		var result models.UpdateLocationResponse
...
func CreateLocationsupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_pos_locations_id",
		mcp.WithDescription("Update Location"),
		...
		mcp.WithString("business_name", mcp.Description("Input parameter: The business name of the location")),
		mcp.WithString("name", mcp.Description("Input parameter: The name of the location")),
		mcp.WithString("status", mcp.Description("Input parameter: Status of this location.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    LocationsupdateHandler(cfg),
	}
}
