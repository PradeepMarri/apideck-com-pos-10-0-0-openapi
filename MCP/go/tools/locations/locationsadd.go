...
func LocationsaddHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/pos/locations%s", cfg.BaseURL, queryString)
		...
		var result models.CreateLocationResponse
...
func CreateLocationsaddTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_pos_locations",
		mcp.WithDescription("Create Location"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    LocationsaddHandler(cfg),
	}
}
