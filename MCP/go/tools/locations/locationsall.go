...
func LocationsallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetLocationsResponse
...
func CreateLocationsallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pos_locations",
		mcp.WithDescription("List Locations"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    LocationsallHandler(cfg),
	}
}
