...
func OrdersoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateOrdersoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pos_orders_id",
		mcp.WithDescription("Get Order"),
