...
func OrdersaddHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateOrdersaddTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_pos_orders",
		mcp.WithDescription("Create Order"),
