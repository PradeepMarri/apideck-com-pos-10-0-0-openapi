...
func OrdersdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteOrderResponse
...
func CreateOrdersdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_pos_orders_id",
		mcp.WithDescription("Delete Order"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    OrdersdeleteHandler(cfg),
	}
}
