...
func OrdersallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/pos/orders%s", cfg.BaseURL, queryString)
...
func CreateOrdersallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pos_orders",
		mcp.WithDescription("List Orders"),
		...
		mcp.WithString("location_id", mcp.Description("ID of the location.")),
