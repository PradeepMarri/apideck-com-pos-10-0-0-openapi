...
func ModifiergroupsoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetModifierGroupResponse
...
func CreateModifiergroupsoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pos_modifier-groups_id",
		mcp.WithDescription("Get Modifier Group"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ModifiergroupsoneHandler(cfg),
	}
}
