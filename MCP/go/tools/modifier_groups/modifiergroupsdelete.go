...
func ModifiergroupsdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteModifierGroupResponse
...
func CreateModifiergroupsdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_pos_modifier-groups_id",
		mcp.WithDescription("Delete Modifier Group"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ModifiergroupsdeleteHandler(cfg),
	}
}
