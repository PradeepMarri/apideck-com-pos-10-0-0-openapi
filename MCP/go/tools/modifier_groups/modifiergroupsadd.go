...
func ModifiergroupsaddHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/pos/modifier-groups%s", cfg.BaseURL, queryString)
		...
		var result models.CreateModifierGroupResponse
...
func CreateModifiergroupsaddTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_pos_modifier-groups",
		mcp.WithDescription("Create Modifier Group"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ModifiergroupsaddHandler(cfg),
	}
}
