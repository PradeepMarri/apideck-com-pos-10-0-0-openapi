...
func ModifiergroupsallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetModifierGroupsResponse
...
func CreateModifiergroupsallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pos_modifier-groups",
		mcp.WithDescription("List Modifier Groups"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ModifiergroupsallHandler(cfg),
	}
}
