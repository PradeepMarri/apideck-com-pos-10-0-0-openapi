...
func ModifiergroupsupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ModifierGroup
		...
		url := fmt.Sprintf("%s/pos/modifier-groups/%s%s", cfg.BaseURL, id, queryString)
		...
		var result models.UpdateModifierGroupResponse
...
func CreateModifiergroupsupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_pos_modifier-groups_id",
		mcp.WithDescription("Update Modifier Group"),
		...
		mcp.WithNumber("maximum_allowed", mcp.Description("")),
		mcp.WithNumber("minimum_required", mcp.Description("")),
		mcp.WithString("selection_type", mcp.Description("")),
		...
		mcp.WithString("alternate_name", mcp.Description("")),
		mcp.WithArray("modifiers", mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ModifiergroupsupdateHandler(cfg),
	}
}
