...
func TendersoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetTenderResponse
...
func CreateTendersoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pos_tenders_id",
		mcp.WithDescription("Get Tender"),
