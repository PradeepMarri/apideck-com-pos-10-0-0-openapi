...
func TendersaddHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/pos/tenders%s", cfg.BaseURL, queryString)
		...
		var result models.CreateTenderResponse
...
func CreateTendersaddTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_pos_tenders",
		mcp.WithDescription("Create Tender"),
