...
func TendersdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteTenderResponse
...
func CreateTendersdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_pos_tenders_id",
		mcp.WithDescription("Delete Tender"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    TendersdeleteHandler(cfg),
	}
}
