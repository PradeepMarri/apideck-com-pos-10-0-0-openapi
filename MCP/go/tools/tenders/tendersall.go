...
func TendersallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetTendersResponse
...
func CreateTendersallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pos_tenders",
		mcp.WithDescription("List Tenders"),
