...
func OrdertypesdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/pos/order-types/%s%s", cfg.BaseURL, id, queryString)
		...
		var result models.DeleteOrderTypeResponse
...
func CreateOrdertypesdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_pos_order-types_id",
		mcp.WithDescription("Delete Order Type"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    OrdertypesdeleteHandler(cfg),
	}
}
