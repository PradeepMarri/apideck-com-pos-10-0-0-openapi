...
func OrdertypesaddHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.OrderType
		...
		url := fmt.Sprintf("%s/pos/order-types%s", cfg.BaseURL, queryString)
		...
		var result models.CreateOrderTypeResponse
...
func CreateOrdertypesaddTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_pos_order-types",
		mcp.WithDescription("Create Order Type"),
		...
		mcp.WithBoolean("default", mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    OrdertypesaddHandler(cfg),
	}
}
