...
func OrdertypesallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetOrderTypesResponse
...
func CreateOrdertypesallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pos_order-types",
		mcp.WithDescription("List Order Types"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    OrdertypesallHandler(cfg),
	}
}
