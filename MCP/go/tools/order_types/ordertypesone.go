...
func OrdertypesoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetOrderTypeResponse
...
func CreateOrdertypesoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pos_order-types_id",
		mcp.WithDescription("Get Order Type"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    OrdertypesoneHandler(cfg),
	}
}
