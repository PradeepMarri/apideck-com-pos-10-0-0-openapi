...
func OrdertypesupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.UpdateOrderTypeResponse
...
func CreateOrdertypesupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_pos_order-types_id",
		mcp.WithDescription("Update Order Type"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    OrdertypesupdateHandler(cfg),
	}
}
