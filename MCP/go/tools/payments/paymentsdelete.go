...
func PaymentsdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeletePosPaymentResponse
...
func CreatePaymentsdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_pos_payments_id",
		mcp.WithDescription("Delete Payment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PaymentsdeleteHandler(cfg),
	}
}
