...
func PaymentsallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetPosPaymentsResponse
...
func CreatePaymentsallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pos_payments",
		mcp.WithDescription("List Payments"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PaymentsallHandler(cfg),
	}
}
