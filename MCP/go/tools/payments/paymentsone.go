...
func PaymentsoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetPosPaymentResponse
...
func CreatePaymentsoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pos_payments_id",
		mcp.WithDescription("Get Payment"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PaymentsoneHandler(cfg),
	}
}
