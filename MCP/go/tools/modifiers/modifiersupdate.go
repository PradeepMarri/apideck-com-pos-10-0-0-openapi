...
func ModifiersupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Modifier
		...
		url := fmt.Sprintf("%s/pos/modifiers/%s%s", cfg.BaseURL, id, queryString)
		...
		var result models.UpdateModifierResponse
...
func CreateModifiersupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_pos_modifiers_id",
		mcp.WithDescription("Update Modifier"),
		...
		mcp.WithString("modifier_group_id", mcp.Required(), mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ModifiersupdateHandler(cfg),
	}
}
