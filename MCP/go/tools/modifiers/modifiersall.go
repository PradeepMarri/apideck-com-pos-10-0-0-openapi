...
func ModifiersallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/pos/modifiers%s", cfg.BaseURL, queryString)
		...
		var result models.GetModifiersResponse
...
func CreateModifiersallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pos_modifiers",
		mcp.WithDescription("List Modifiers"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ModifiersallHandler(cfg),
	}
}
