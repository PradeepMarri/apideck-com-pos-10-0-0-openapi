...
func ModifiersdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteModifierResponse
...
func CreateModifiersdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_pos_modifiers_id",
		mcp.WithDescription("Delete Modifier"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ModifiersdeleteHandler(cfg),
	}
}
