...
func ModifiersoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetModifierResponse
...
func CreateModifiersoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pos_modifiers_id",
		mcp.WithDescription("Get Modifier"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ModifiersoneHandler(cfg),
	}
}
