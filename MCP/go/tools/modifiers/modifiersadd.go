...
func ModifiersaddHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.CreateModifierResponse
...
func CreateModifiersaddTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_pos_modifiers",
		mcp.WithDescription("Create Modifier"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ModifiersaddHandler(cfg),
	}
}
